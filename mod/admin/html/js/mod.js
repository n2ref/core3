			...
			function(data, textStatus){
				if(textStatus == 'success') {
					data.forEach(function(item, i, arr) {
						...
						obj_do.html(obj_do.html() + '<div style="display: inline-block;" onclick="modules.updateModule(\'' + item.m_name + '\', \'' + item.version + '\', \'' + item.module_id + '\');"><img src="core3/html/' + theme + '/img/box_refresh.png" border="0" title="Обновить модуль" /></div>');
					});
				}
			},
			'json'
